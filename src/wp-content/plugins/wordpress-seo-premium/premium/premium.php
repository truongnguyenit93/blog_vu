...
class WPSEO_Premium {
	...
	public function __construct() {
		...
		global $pagenow;
		if ( $this->load_metabox( $pagenow ) ) {
			$this->integrations['premium-metabox'] = new WPSEO_Premium_Metabox();
			$this->integrations['social-previews'] = new WPSEO_Social_Previews();
			$this->integrations['multi_keyword']   = new WPSEO_Multi_Keyword();

			// Add custom fields plugin to post and page edit pages.
			$this->integrations['premium-custom-fields'] = new WPSEO_Custom_Fields_Plugin();
		}
